...
document.getElementById("city-select").addEventListener("change", function () {
  ...
  if (city === "hcm") {
    ...
    alert(
      "Hiện tại chúng tôi chưa có cửa hàng tại Hà Nội. Vui lòng chọn thành phố khác."
    );
  } else if (city === "dn") {
    alert(
      "Hiện tại chúng tôi chưa có cửa hàng tại Đà Nẵng. Vui lòng chọn thành phố khác."
    );
  }
});
